              ...
              <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg border shadow-lg py-1 z-20">
                ...
                <div className="p-2">
                  <button
                    ...
                    className="w-full inline-flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium bg-red-50 text-red-700 hover:bg-red-100 transition-all active:scale-95 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-1"
                  >
